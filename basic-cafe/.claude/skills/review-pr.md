...
Review a pull request against basic-cafe's architecture and conventions.
...
- [ ] Prices stored/transmitted as int64 (cents), never float
...
- [ ] Payment logic goes through payment.Provider interface, not SDK directly
...
- [ ] Success/error toast notifications present

### General
- [ ] No hardcoded environment-specific values
- [ ] No secrets or credentials committed
- [ ] New features covered in `plans/` if significant architecture change
